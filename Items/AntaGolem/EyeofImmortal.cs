...
{
    public class EyeofImmortal :ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.damage = 34;
            item.shoot = ProjectileType<AthanasyEye>();
                ...
                if ((!flag42 && !flag44) || projectile.ai[0] == 180f)
                {
                    ...
                    for (int num916 = 0; num916 < 200; num916 = num3 + 1)
                    {
                        ...
                        if (npc9.active && projectile.Distance(npc9.Center) < 500f && npc9.CanBeChasedBy(this, false) && Collision.CanHitLine(npc9.position, npc9.width, npc9.height, vector111, 0, 0))
                        {
                            ...
                            num3 = num914;
                            num914 = num3 + 1;
                            //Projectile p = Main.projectile[Projectile.NewProjectile(vector111.X, vector111.Y, vector112.X, vector112.Y, ProjectileType<衰落之眼>(), 0, 0f, projectile.owner, (float)projectile.whoAmI, 0f)];
                    ...
                    for (int num918 = 0; num918 < 6; num918 = num3 + 1)
                    {
                        ...
                        //Projectile.NewProjectile(vector111.X, vector111.Y, vector113.X, vector113.Y, ModContent.ProjectileType<衰落之眼>(), 0, 0f, projectile.owner, (float)projectile.whoAmI, 0f);
                        num3 = num918;
                    }
                    projectile.ai[0] = 180f;
                    projectile.netUpdate = true;
