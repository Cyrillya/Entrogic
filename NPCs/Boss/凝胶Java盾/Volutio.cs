...
namespace Entrogic.NPCs.Boss.凝胶Java盾
{
    ...
    public class Volutio : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            bossBag = ItemType<VolutioTreasureBag>();
        }
        public override void HitEffect(int hitDirection, double damage)
        {
            if ((float)npc.life <= 0)
            {
                ...
                {
                    Item.NewItem(npc.getRect(), ItemType<VTrophy>());
        ...
        public override void NPCLoot()
        {
            ...
            {
                if (Main.rand.Next(7) == 0) Item.NewItem(npc.getRect(), ItemType<VolutioMask>());
                Item.NewItem(npc.getRect(), ItemType<GelOfLife>(), Main.rand.Next(11, 14 + 1));//11-14
            }
            Item.NewItem(npc.getRect(), ItemType<MagicDiversionPlatform>());
        }
        ...
        public override void AI()
        {
            ...
            else if (npc.ai[3] == 300)
            {
                if (Main.netMode != NetmodeID.MultiplayerClient)
                {
                    ...
                    Projectile.NewProjectile(npc.Center + new Vector2(0f, 120f), new Vector2(14f), ProjectileType<SymbioisDeathLaser>(), damage, 10, Main.myPlayer, 0, npc.whoAmI);
                    npc.netUpdate = true;
                }
            }
            ...
            {
                NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, NPCType<IREUL>());
                npc.ai[3] = 0;
            }
        }
