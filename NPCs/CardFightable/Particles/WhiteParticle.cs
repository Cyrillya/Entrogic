...
{
    public class WhiteParticle : Particle
    {
        public WhiteParticle() : base()
        {
            _texture = (Texture2D)ModContent.GetTexture(typeof(WhiteParticle).FullName.Replace('.', '/') + $"_{Main.rand.Next(3)}");
        }
