// https://github.com/ChevyRay/Coroutines.git
// 协议 MIT
// License MIT
...
namespace Entrogic.Core
{
    ...
    public class CoroutineRunner
    {
        ...
        /// <param name="delay">How many frames to delay before starting.</param>
        /// <param name="routine">The routine to run.</param>
        public CoroutineHandle Run(int delay, IEnumerator routine) {
            running.Add(routine);
            delays.Add(delay);
        ...
        /// <param name="deltaTime">How many frames have passed sinced the last update.</param>
        ...
        bool MoveNext(IEnumerator routine, int index) {
            ...
            if (routine.Current is int)
                delays[index] = (int)routine.Current;
