...
namespace Entrogic.Projectiles.Magic.小刀
{
    public class 琥珀小刀 : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            for (int i = 0; i < 17; i++)
            {
                int num = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, 87, 0f, 0f, 90, default(Color), 0.75f);
