...
{
    public class 菠萝碎片 : ArcaneProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int j = 0; j < 5; j++)
            {
                int num = Dust.NewDust(new Vector2(base.projectile.position.X, base.projectile.position.Y), base.projectile.width, base.projectile.height, 6, 0f, 0f, 100, default(Color), 0.85f);
                Main.dust[num].velocity *= 1f;
