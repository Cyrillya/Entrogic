...
namespace Entrogic
{
    ...
    public static class RareID
    {
        ...
        /// </summary>
        public const int LV0 = ItemRarityID.Gray;
        /// <summary>
        /// 白色 - White
        ...
        /// </summary>
        public const int LV9 = ItemRarityID.Yellow;
        /// <summary>
        /// 青色 - Cyan
        ///这又是一个比较小的级别，包含来自月亮事件的早期物品，主要是月亮碎片和天塔柱，以及月亮领主的部分掉落物。
        ///也包括偶尔可以从专家模式的宝藏袋中得到的开发者物品。对于移动版 移动版和3DS版 版，这个级别内只有重铸过的基础稀有度青柠色或黄色为武器与配饰。
        /// </summary>
        public const int LV10 = ItemRarityID.Cyan;
        /// <summary>
        /// 红色 - Red
        ///用月亮碎片和夜明矿在远古操纵机处制作出来的物品。以及一部分直接掉落自月亮领主的物品，包括远古操纵机本身。
        ///还包括某些武器如泰拉刃或配饰如霜花靴的高端重铸版本。
        /// </summary>
        public const int LV11 = ItemRarityID.Red;
        /// <summary>
        /// 紫色 - Purple
        ///这个级别由拥有高级修饰语的青色与红色物品构成。目前没有基准稀有度在这个级别的物品。
        /// </summary>
        public const int LV12 = ItemRarityID.Purple;
        /// <summary>
        ...
        /// </summary>
        public const int Rainbow = ItemRarityID.Expert;
        /// <summary>
