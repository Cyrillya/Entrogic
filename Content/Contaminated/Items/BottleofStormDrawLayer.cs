namespace Entrogic.Content.Contaminated.Items
{
    ...
    public class BottleofStormDrawLayer : PlayerDrawLayer
    {
        ...
        public override bool GetDefaultVisibility(PlayerDrawSet drawInfo) {
            return drawInfo.drawPlayer.GetModPlayer<BottleofStormPlayer>().HasWings;
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo) {
            ...
            if (drawInfo.drawPlayer.ShouldDrawWingsThatAreAlwaysAnimated()) {
                ...
                frame.Width -= 2;
                frame.Height -= 2;
                DrawData data = new(texture.Value, drawPosition.Floor(), frame, color, drawInfo.drawPlayer.bodyRotation, frame.Size() / 2f, 1f, drawInfo.playerEffect, 0);
