    ...
    public class Migrant : NPCBase
    {
        ...
        public override void AI()
        {
            ...
            if (NPC.ai[0] % 115 == 0 && master.ai[0] != 4f && Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                //{
                    ...
                    Projectile shots = Main.projectile[Projectile.NewProjectile(NPC.GetProjectileSpawnSource(), NPC.Center, velo, ModContent.ProjectileType<ContaSpike>(), (int)(23 * NPC.scale), 2f)];
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                int shark = NPC.NewNPC((int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<PolluShark>(), 0, 0, 0, -15, mid);
                if (Main.netMode == NetmodeID.Server)
                {
