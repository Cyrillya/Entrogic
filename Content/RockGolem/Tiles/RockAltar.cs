using Entrogic.Content.RockGolem.HostileProjectiles;
using Entrogic.Content.RockGolem.Items;
using Entrogic.Core.BaseTypes;
using Entrogic.Helpers;
using Terraria.GameContent.ObjectInteractions;

namespace Entrogic.Content.RockGolem.Tiles
{
    public class RockAltar : TileBase
    {
        ...
        public override void SetDrawPositions(int i, int j, ref int width, ref int offsetY, ref int height, ref short tileFrameX, ref short tileFrameY) {
            if (NPC.AnyNPCs(ModContent.NPCType<RockGolem.Enemies.Athanasy>())) {
                tileFrameX += 18 * 6;
            }
        }
