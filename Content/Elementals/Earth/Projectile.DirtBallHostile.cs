...
{
    public class DirtBallHostile : ProjectileBase
    {
        ...
        public override void Kill(int timeLeft) {
            ...
            if (timeLeft > 10) {
                ...
                if (!Main.tile[num833, num834].HasUnactuatedTile) {
                    bool flag5 = num834 < Main.maxTilesY - 2 && Main.tile[num833, num834 + 1] != null && Main.tile[num833, num834 + 1].HasUnactuatedTile && Main.tile[num833, num834 + 1].TileType == 314;
                    if (!flag5) {
