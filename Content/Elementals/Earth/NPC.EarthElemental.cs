            ...
            switch ((NPCState)State) {
                ...
                case NPCState.Attack: {
                        ...
                        if (Timer == 32 && Main.netMode != NetmodeID.MultiplayerClient) {
                            ...
                            Projectile.NewProjectile(NPC.GetSource_FromAI(), shootPos, mid.ToRotationVector2() * 15f, ModContent.ProjectileType<DirtBallHostile>(), NPC.damage / 2, 1f, Main.myPlayer);
                            NPC.netUpdate = true;
                        }
                        // 第12帧结束 (4*11=44)
                        if (Timer >= 44) {
