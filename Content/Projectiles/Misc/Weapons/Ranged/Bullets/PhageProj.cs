    ...
    public class PhageProj : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < DUST_AMOUNTS; i++)
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.t_Slime, (float)(Main.rand.NextBool(2) ? 1 : -1), -2f, Projectile.alpha + 60, new Color(0, 70, 118, 137), 1f);
        }
