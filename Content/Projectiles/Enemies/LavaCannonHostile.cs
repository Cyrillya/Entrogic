    ...
    public class LavaCannonHostile : ProjectileBase
	{
        ...
        public override void Kill(int timeLeft) {
			...
			for (int g = 0; g < Main.rand.Next(4, 7); g++) {
				...
				Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), pos, new Vector2(Main.rand.NextFloat(-13, 14), Main.rand.NextFloat(-8, -16)), ModContent.ProjectileType<LavaCannonFlame>(), damage, Projectile.knockBack, Projectile.owner);
			}
		}
