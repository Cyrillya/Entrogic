...
{
    public override string Texture => "Entrogic/Assets/Images/Glow/GlowSoft";

    public override void OnSpawn(Dust dust)
    {
        dust.noGravity = true;
        dust.frame = new Rectangle(0, 0, 64, 64);
        dust.shader = new Terraria.Graphics.Shaders.ArmorShaderData(new Ref<Effect>(Entrogic.Instance.Assets.Request<Effect>("Assets/Effects/GlowingDust", AssetRequestMode.ImmediateLoad).Value), "GlowingDustPass");
    }
